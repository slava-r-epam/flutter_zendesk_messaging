...
public class AdaChatPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "setLanguage":
      ...
      adaChatService.setLanguage(language: language)
      break
      
    case "setMetaFields":
      let metafields = arguments?["metafields"] as! [String : Any]
      
      adaChatService.setMetaFields(metafields: metafields)
      break
      
    case "setSensitiveMetaFields":
      let metafields = arguments?["sensitiveMetafields"] as! [String : Any]
      
      adaChatService.setSensitiveMetaFields(metafields: metafields)
      break
